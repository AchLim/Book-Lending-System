    ...
    MultiSelect.prototype = {
        ...
        _updatePlaceholderText: function(){
            ...
            for( var key in selectVals ) {
                ...
                selOpts.push(
                    '<span class="badge bg-primary">' + select.find('option[value="'+ instance._escapeSelector( selectVals[ key ] ) +'"]').text() + '</span>'
                );
            ...
            // Updated by Achordion - Instead of .text(), I uses .html() to get the badge css.
